...
- `working → ready_for_test`：developer 提交修复 report 和 self-review，frontmatter 必须包含 `related_issue: issue-*.md`。
- 若 owner 插入 reviewer gate:`ready_for_test → waiting_review → under_review → ready_for_test / review_rejected`。
